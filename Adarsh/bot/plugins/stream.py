...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        msg_text ="""<i><u>Link Generado !</u></i>\n\n<b>📂 ARCHIVO :</b> <i>{}</i>\n\n<b>📦 TAMAÑO :</b> <i>{}</i>\n\n<b>📥 DESCARGA :</b> <i>{}</i>\n\n<b>🖥 ONLINE (Navegador) :</b> <i>{}</i>\n\n<b>🚸 NOTA : PARA ABRIR CON REPRODUCTOR ELEGIR ENLACE DE DESCARGA, (VLC,MxPlayer...)</b>"""
...
async def channel_receive_handler(bot, broadcast):
    ...
    try:
        ...
        await bot.edit_message_reply_markup(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("🖥ONLINE (Navegador)", url=f"http://ouo.io/qs/Ckivdltb?s={Var.URL}watch/{str(log_msg.id)}/{quote_plus(get_name(log_msg))}?hash={get_hash(log_msg)}"
